...
st.info("Фоновый режим работает по стратегии `Protect Margin`: автоматически поднимает цену только у товаров с прибылью ниже цели и не снижает цену у товаров с прибылью выше цели.")
